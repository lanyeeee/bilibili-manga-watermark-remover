...
async getMangaSizes(mangaDir: string) : Promise<MangaSize[]> {
return await TAURI_INVOKE("get_manga_sizes", { mangaDir });
}
}
...
export type MangaSize = { width: number; height: number; count: number }
